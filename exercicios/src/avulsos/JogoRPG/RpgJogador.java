...
public class RpgJogador 
{
	...
	public void golpearInimigo() 
	{
		...
		if(dadoVinte == 20 && RpgInimigo.vidaInimigo > 0) 
		{
			...
			System.out.println("Dano crítico! " + RpgInimigo.nomeInimigo + " perdeu 40 de vida");
		...
		{
			vidaJogador -= 40;
			System.out.println("Você se deu mal! " + nomeJogador + " perdeu 40 de vida");
